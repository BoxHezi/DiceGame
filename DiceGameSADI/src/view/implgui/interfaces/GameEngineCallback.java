package view.implgui.interfaces;
...
public interface GameEngineCallback {
     ...
     * @param dicePair   the current (upfacing) values of the rolling dice
     * @param gameEngine a convenience reference to the engine so the receiver can call
     ...
     *
     * @param player     the Player who rolled
     * @param result     the final resting state of the rolled dice
     * @param gameEngine a convenience reference to the engine so the receiver can call
     *                   methods if necessary
     * @see model.interfaces.GameEngine
     */
