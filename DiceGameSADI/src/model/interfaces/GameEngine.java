...
public interface GameEngine {
     ...
     *
     * @param player         the player who is rolling and will have their result set
     *                       at the end of the roll
     * @param initialDelay   the starting delay in ms between updates (based on how fast
     *                       dice are rolling)
     * @param finalDelay     the final delay in ms between updates when the dice stop
     *                       rolling
    ...
    /**
     * @param gameEngineCallback a client specific implementation of GameEngineCallback used to
    ...
    /**
     * @param gameEngineCallback called when a player quits the game to remove no longer needed
     *                           UI updates
